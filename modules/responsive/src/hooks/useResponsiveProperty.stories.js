...
import useResponsiveProperty from './useResponsiveProperty'

export default {
  method: useResponsiveProperty,
  title: 'responsive/useResponsiveProperty',
  decorators: [withResponsiveContext]
}

export const Basic = () => {
  const { current, width } = useResponsive()
  const property = useResponsiveProperty()
